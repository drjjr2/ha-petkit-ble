...
class Commands:
    ...
    def init_device_data(self):
        ...
        # Round 22 bonus fix: this was decoded above but never actually
        # assigned — utils.py's calculate_water_purified()/
        # calculate_energy_usage() branch on device.alias ("W5C"/"W4X"/
        # else-default), so leaving it at its "Uninitialized" default meant
        # those calculations always took the default branch regardless of
        # the real model.
